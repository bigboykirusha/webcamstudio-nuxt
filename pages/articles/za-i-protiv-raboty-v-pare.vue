<template>
  <header>
    <h1 class="InteriorTitle">
      ЗА И ПРОТИВ
      <span class="InteriorTitleSpan">РАБОТЫ В ПАРЕ</span>
    </h1>
    <nav class="InteriorTitleNav selectNone">
      ...
      <span class="InteriorTitleNavSpan">&gt</span>
      <span class="noDecorationLink pointer">За и против работы в паре</span>
    </nav>
    <div class="ArticleImage">
      <img class="ArticleImg" src="/src/assets/images/BlogPhoto9Full.webp" />
    </div>
  </header>
  ...
  <main>
    <section class="InteriorText">
      <div class="InteriorTextPadding">
        <p class="">
          Хочешь поработать вместе со своим парнем/девушкой? Это возможно, но
          сначала прочти этот пост и прикинь стоит ли игра свеч.
        </p>
        <p class="InteriorTextTitle">Плюсы:</p>
        <ul class="noListStyle">
          <li>
            ➕ Таких как вы не так много, как моделей-одиночек, поэтому
            конкуренции значительно меньше, а следовательно больше зрителей и
            скорость набора подписчиков.
          </li>
          <li>
            ➕ Вдвоём проработать несколько часов намного проще и интереснее,
            ведь вы можете общаться, тогда как одному, особенно в начале пути,
            придётся столкнуться с молчанием в чате.
          </li>
          <li>
            ➕ Не так важно вообще знание английского языка, ведь мемберы будут
            заходить к вам за шоу, поуправлять онлайн порно, поэтому достаточно
            выучить выражений и иметь переводчик под рукой.
          </li>
        </ul>
        <p class="InteriorTextTitle">Теперь к минусам:</p>
        <ul class="noListStyle">
          <li>
            ➖ Весь ваш доход вы делите пополам. Тут уж сам(а) думай минус ли
            это для тебя, но, скорее всего, по одному вы бы зарабатывали больше.
          </li>
          <li>
            ➖ Чаще всего девушке приходится больше выкладываться, ведь основная
            часть зрителей пришла именно на неё посмотреть.
          </li>
          <li>
            ➖ Это может негативно повлиять на ваши отношения. Все, конечно,
            зависит только от вас, но работать с друзьями и любимыми в любой
            сфере бывает сложно.
          </li>
          <li>
            ➖ Поругались? Стрима не будет. Кто-то один не может? Стрима не
            будет. Вы зависите друг от друга.
          </li>
        </ul>
        <p class="">
          Надеюсь, этот пост поможет вам принять правильное решение.
        </p>
      </div>
    </section>
...
function prepareSharing() {
  ...
  const imageUrl = encodeURIComponent(
    "https://i.ibb.co/pxsYvDX/Blog-Photo9-Full.webp"
  );
