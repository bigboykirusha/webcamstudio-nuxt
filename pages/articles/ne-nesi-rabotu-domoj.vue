<template>
  <header>
    <h1 class="InteriorTitle">
      НЕ НЕСИ
      <span class="InteriorTitleSpan">РАБОТУ ДОМОЙ!</span>
    </h1>
    <nav class="InteriorTitleNav selectNone">
      ...
      <span class="InteriorTitleNavSpan">&gt</span>
      <span class="noDecorationLink pointer">Не неси работу домой!</span>
    </nav>
    <div class="ArticleImage">
      <img class="ArticleImg" src="/src/assets/images/BlogPhoto2Full.webp" />
    </div>
  </header>
  ...
  <main>
    <section class="InteriorText">
      <div class="InteriorTextPadding">
        <p class="">
          В любой творческой профессии, требующей большой эмоциональной отдачи,
          присутствует риск выгорания, но в нашей нише улыбка и блеск в глазах
          играют особую роль, непосредственно влияя на заработок. Поэтому так
          важно заранее планировать свой график работы и отдыха, иметь здоровый
          сон.
        </p>
        <p class="">
          Немаловажно и умение разделять игру на камеру и реальную жизнь, не
          оставаться в образе, выходя из кадра. Если ты будешь постоянно жить
          работой, твои ресурсы будут истощаться, приводя к апатии и нервным
          срывам.
        </p>
        <p class="">
          Особенно сложно бывает отпустить и оставить на работе негатив.
          Ожидал(а) большего от смены? Оставили плохой отзыв? Нагрубили в чате?
          Это интернет, тут случается всякое. Не позволяй себе думать об этом,
          мозгу нужна разгрузка. Послушай после работы любимую музыку и отпусти
          все.
        </p>
        <p class="">
          Проще, конечно, соблюдать эти правила, работая у нас на студии, так
          как дома ты будешь постоянно находиться на рабочем месте, что не есть
          хорошо. Также, наши опытные администраторы подберут подходящий тебе
          график и зарядят тебя настроением и мотивацией.
        </p>
      </div>
    </section>
...
function prepareSharing() {
  ...
  const imageUrl = encodeURIComponent(
    "https://i.ibb.co/0C9vKHn/Blog-Photo2-Full.webp"
  );
