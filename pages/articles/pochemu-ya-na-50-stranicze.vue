<template>
  <header>
    <h1 class="InteriorTitle">
      ПОЧЕМУ Я НА
      <span class="InteriorTitleSpan">50 СТРАНИЦЕ?</span>
    </h1>
    <nav class="InteriorTitleNav selectNone">
      ...
      <span class="InteriorTitleNavSpan">&gt</span>
      <span class="noDecorationLink pointer">Почему я на 50 странице?</span>
    </nav>
    <div class="ArticleImage">
      <img class="ArticleImg" src="/src/assets/images/BlogPhoto6Full.webp" />
    </div>
  </header>
  ...
  <main>
    <section class="InteriorText">
      <div class="InteriorTextPadding">
        <p class="">
          Алгоритмы кам-сайтов очень сложны и учитывают массу деталей, таких как
          конверсия просмотров в доход, твоё время онлайн и так далее.
          Разобраться в этом довольно непросто, но мы знаем какие шаги нужно
          предпринять, чтобы улучшить свои позиции в топе.
        </p>
        <p class="">
          Составь себе расписание и придерживайся его. Таким образом ты скоро
          наберёшь аудиторию, которая сидит на сайте в то же время, что и ты. И
          не забывай перед началом стрима уведомить своих подписчиков.
        </p>
        <p class="">
          Заведи блокнот и записывай туда во время стрима (или сразу после)
          действия, которые привлекли больше зрителей в твою комнату, а так же
          образы и фетиши, которые нравятся твоим мемберам.
        </p>
        <p class="">
          Разберись с тегами, тип-меню и био. Теги могут быть не актуальными, а
          тип-меню и био слишком пустыми (кстати, прошлый пост в помощь).
          <br />
          Никогда не забывай улыбаться, можешь даже сделать это прямо сейчас для
          тренировки ?
        </p>
      </div>
    </section>
...
function prepareSharing() {
  ...
  const imageUrl = encodeURIComponent(
    "https://i.ibb.co/QQDc4fX/Blog-Photo6-Full.webp"
  );
