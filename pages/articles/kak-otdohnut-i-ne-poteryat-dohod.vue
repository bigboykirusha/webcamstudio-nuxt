<template>
  <header>
    <h1 class="InteriorTitle">
      КАК ОТДОХНУТЬ
      <span class="InteriorTitleSpan">И НЕ ПОТЕРЯТЬ ДОХОД</span>
    </h1>
    <nav class="InteriorTitleNav selectNone">
      ...
      <span class="noDecorationLink pointer"
        >Как отдохнуть и не потерять доход</span
      >
    </nav>
    <div class="ArticleImage">
      <img class="ArticleImg" src="/src/assets/images/BlogPhoto10Full.webp" />
    </div>
  </header>
  ...
  <main>
    <section class="InteriorText">
      <div class="InteriorTextPadding">
        <p class="">
          Вот у тебя на носу долгожданный отпуск, но ты боишься, что по
          возвращении про тебя все забудут и твой доход значительно упадёт? Вот
          несколько простых шагов, которые помогут, если не предотвратить, то
          минимизировать потери.
        </p>
        <ol>
          <li>
            Обязательно предупреди своих подписчиков о том что ты уходишь
            наполняться новыми силами, идеями для шоу и на сколько.
          </li>
          <li>
            Периодически напоминай о себе, если ты ведёшь рабочие странички в
            Инстаграм, Твиттере. Если напишут — не поскупись на ответ. Также ты
            можешь вести обратный отсчёт до своего грандиозного возвращения.
          </li>
          <li>
            Если есть возможность делать рассылки с сайта — пользуйся этим.
          </li>
          <li>
            Отдых хорошо сказывается на вдохновении, так что если ты вернёшься с
            новыми шоу или обзаведёшься новыми образами, твои подписчики это
            оценят.
          </li>
        </ol>
      </div>
...
function prepareSharing() {
  ...
  const imageUrl = encodeURIComponent(
    "https://i.ibb.co/c197BGz/Blog-Photo10-Full.webp"
  );
